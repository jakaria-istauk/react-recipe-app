...
import { setLoggedOut } from '../../hooks/authentication';
    ...
    <header className="p-3 bg-dark text-white">
      <nav className="navbar navbar-expand-lg navbar-light bg-dark text-white">
        <div className="container">
          ...
          <div className={`${!userData?.isLoggedIn ? 'd-md-flex' : ''} logged-btns ${dropDown ? 'responsive' : ''}`}>
            {
              !userData?.isLoggedIn ?
               <>
              ...
              <div className="nav-item dropdown">
                ...
                <div onClick={dropDownHandler} className={`dropdown-toggle ${dropDown?'show':''}`}>
                  ...
                  <span className='ms-1 text-capitalize'>{userData?.username}</span>
                </div>
                {
                  ! dropDown ? '' :
